...
before_filter :authenticate_user!
    ...
    def supplier_offer
        if can? :work_suppliers, :all
            if params[:complete]
                @part = PItem.where(user_do: '999',suppliers_tag: 'done').paginate(:page => params[:page], :per_page => 10)
                ...
                @part = PItem.where(user_do: '999',suppliers_tag: nil).paginate(:page => params[:page], :per_page => 10)
            else
